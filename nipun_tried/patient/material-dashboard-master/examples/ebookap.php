...
<head>
  ...
  <link href="../assets/demo/demo.css" rel="stylesheet" />
    ...
    <!-- Main css --> <!--  <script> function getdoctor(val) { $.ajax({ type:
"POST", url: "get_doctor.php", data:'specilizationid='+val, success:
function(data){ $("#doctor").html(data); } }); } </script> --> <script
type="text/javascript"> function run(a) { self.location='ebookap.php?cat=' + a
; // document.getElementById("nipun").value = a ; // document.write("hello");
