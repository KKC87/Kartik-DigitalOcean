<?php
    ...
    if (isset($_POST['submit']))
    {
        ...
        if (mysqli_query($con, $sql))
        {
            ...
            echo "<script> location.href='/themes/patient/material-dashboard-master/examples/dashboard.php'; </script>";
        }
...
<head>
 ...
 <script type="text/javascript">
     function run(a)
     {
        self.location='sbookap.php?cat=' + a ;
     ...
     function runa(b)
     {
      self.location='bookap.php?cata=' + b ;
     }
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item active ">
            <a class="nav-link" href="bookap.php">
          ...
          <li class="nav-item">
            <a class="nav-link" href="patient_ap.php">
              <i class="material-icons">person</i>
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                  ...
                  <a class="dropdown-item" href="\themes\doctor\now-ui-dashboard-master\examples\logout.php"><button class="btn">Log out</button></a>
                <!-- </div> -->
              </li>
            </ul>
          </div>
                ...
                <div class="signup-content">
                    ...
                    <?php
                        ...
                        <div class="form-group">
                            ...
                            $pname = $_SESSION['pa'];
                            ?>
                          patientname: <input type="text" id="start" value="<?php echo $pname?>">
                        </div>
                        ...
                        <br>
                        <div class="form-group">
                           Consultancy Fees <input type="text" readonly="readonly" class="form-input" name="Fees" placeholder="Fees" value="<?php echo $fee-100 ?>"/>
                        </div>
                        <br>
                        <br>
